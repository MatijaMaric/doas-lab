...
\begin{enumerate}
    \item 
        \begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Procjene gradijenta kompas operatorima za kuteve \ang{0}, \ang{45} i \ang{90}}
        \end{minipage}
    \item
    ...
    \item
        \begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Amplitudni i fazni spektri kompas operatora za kuteve \ang{0}, \ang{45} i \ang{90}}
        \end{minipage}
    \item
...
\begin{enumerate}
    \item
        \begin{minipage}{\linewidth}
            ...
            \captionof{figure}{Procjene gradijenta Laplacevim operatorima za parametar $\alpha \in [0, 0.2, 0.5, 1]$}
        \end{minipage}
    \item
...
\begin{enumerate}
	\item
		\begin{minipage}{\linewidth}
			...
			\captionof{figure}{Značajke teksture za pomak [2, 2]}
		\end{minipage}
		\begin{minipage}{\linewidth}
			\centering
			\includegraphics[width=0.75\textwidth]{texture44}
			\captionof{figure}{Značajke teksture za pomak [4, 4]}
		\end{minipage}
		\begin{minipage}{\linewidth}
			\centering
			\includegraphics[width=0.75\textwidth]{texture35}
			\captionof{figure}{Značajke teksture za pomak [3, 5]}
		\end{minipage}
	\item
		\begin{minipage}{\linewidth}
			\centering
			\includegraphics[width=0.75\textwidth]{textureorig}
			\captionof{figure}{Originalne slike tekstura {\it tekstura\_nebo.png} i {\it tekstura\_plast1.png}}
		\end{minipage}
		\begin{minipage}{\linewidth}
			\centering
			\includegraphics[width=0.75\textwidth]{texturecovar}
			\captionof{figure}{Kovarijanca za slike tekstura {\it tekstura\_nebo.png} i {\it tekstura\_plast1.png}}
		\end{minipage}
